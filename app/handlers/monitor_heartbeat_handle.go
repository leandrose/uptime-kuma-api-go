...
func MonitorHeartbeatsGetHandle(c echo.Context) error {
	...
	heartbeats := service.GetMonitorHeartbets(monitorID)
	return http.MonitorHeartbeatsPresenter(c.Response(), heartbeats)
}
